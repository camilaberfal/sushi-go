...
1. Barajar todas las cartas y repartir según el número de jugadores:

   | Jugadores | Cartas por jugador |
   |---|---|
   | 2 | 10 |
   | 3 | 9 |
   | 4 | 8 |
...
2. Las cartas restantes se colocan boca abajo en el centro como pila de robo.
3. Designar a un jugador como anotador y tener papel y lápiz a mano.
...
3. Cada jugador **pasa su mano restante al jugador de su izquierda**.
4. Se repite el proceso con la nueva mano (que ahora es más pequeña).

> **Nota:** Las cartas reveladas permanecen frente a ti hasta el final de la ronda. Es útil agrupar las cartas del mismo tipo.
...
Cuando se pasa la última carta de cada mano, simplemente se coloca boca arriba junto a las demás cartas recolectadas.

Se puntúan las cartas recolectadas, **excepto los Puddings**, que se guardan frente a ti para ser puntuados al final del juego.
...
- **Par de 2 cartas:** 5 puntos
- **1 carta sola:** 0 puntos
- Se pueden puntuar múltiples pares en una ronda.
...
| Nigiri | Valor base | Con Wasabi (x3) |
|---|---|---|
| Squid Nigiri | 3 pts | 9 pts |
| Salmon Nigiri | 2 pts | 6 pts |
| Egg Nigiri | 1 pt | 3 pts |

- Un Wasabi **sin Nigiri** encima: 0 puntos.
...
3. Repartir a cada jugador una nueva mano con la misma cantidad de cartas que la ronda anterior.

---

## Final del Juego

Después de la tercera ronda, las cartas restantes en la pila de robo se ignoran. Se puntúan los **Puddings**:

### Puddings

- **Más cartas:** +6 puntos
- **Menos cartas** (incluido 0): −6 puntos
- En caso de empate, se reparten los puntos en partes iguales.
- Si todos tienen la misma cantidad, nadie puntúa.

> **Nota en partidas de 2 jugadores:** Nadie pierde puntos por Puddings. Solo se otorgan puntos al jugador con más.
...
| Wasabi | 0 pts (triplica el siguiente Nigiri) |
| Chopsticks | 0 pts (permite tomar 2 cartas) |
| Pudding (fin) | +6 pts (más) / −6 pts (menos) |