...
export interface HighlightStats {
  ...
  mostProfitableCard: { cardId: string; totalPointsGenerated: number; playerName: string; };
}
    ...
    <section className="mx-auto w-full max-w-4xl px-4 mt-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 px-2">
        ...
        <MetricCard
          ...
          value={
            <>
              {stats.mostProfitableCard.totalPointsGenerated} pts <span className="text-emerald-400 text-xs">por {stats.mostProfitableCard.playerName}</span>
            </>
          }
          icon="💰"
