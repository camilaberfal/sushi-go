$pageFile = 'C:\Proyectos\sushi-go\src\components\scoreboard\AchievementBadge.tsx'
$content = @"
"use client";
  ...
  return (
    <motion.div
      ...
      className={`group flex flex-col items-center p-3 rounded-2xl bg-[#1c0d12] shadow-[0_8px_15px_rgba(0,0,0,0.6),inset_0_2px_4px_rgba(255,255,255,0.02),inset_0_-3px_8px_rgba(0,0,0,0.6)] ${
        isUnlocked ? "hover:-translate-y-2 transition-transform duration-300" : "grayscale"
      }`}
      style={{ borderBottom: `4px solid ${achievement.accent}99` }}
    >
...
"@
[System.IO.File]::WriteAllText($pageFile, $content, (New-Object System.Text.UTF8Encoding $false))
