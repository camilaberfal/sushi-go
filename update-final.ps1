$finalFile = 'C:\Proyectos\sushi-go\src\components\scoreboard\FinalScoreboard.tsx'
$content = @"
"use client";
...
export function FinalScoreboard({
  ...
  return (
    ...
    >
      {/* Texture overlay matching glass-scoreboard */}
      ...
      <div className="relative z-10 w-full max-w-[1000px] mx-auto flex flex-col pt-5 pb-10 px-4">
        ...
        {/* LOGO AND HEADER aligned with game HUD style */}
        <motion.header
        ...
        {/* ACTION BUTTONS (styled like game action area!) */}
        <motion.footer
...
"@
[System.IO.File]::WriteAllText($finalFile, $content, (New-Object System.Text.UTF8Encoding $false))
