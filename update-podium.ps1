$podiumFile = 'C:\Proyectos\sushi-go\src\components\scoreboard\Podium.tsx'
$content = @"
"use client";
...
"@
[System.IO.File]::WriteAllText($podiumFile, $content, (New-Object System.Text.UTF8Encoding $false))
